<?php
    ...
    if($_POST){
        if(isset($_POST["booknow"])){
            ...
            $sql2="insert into appointment(pid,apponum,scheduleid,appodate,expected_time) values ($userid,$apponum,$scheduleid,$date
            $date)";
 ...
 <div class="container">
    ...
    if ($_GET) {
        if (isset($_GET["id"])) {
            ...
            $startTime = strtotime('09:39 AM'); // Convert the starting time to a Unix timestamp
            $interval = 30 * 60; // Interval in seconds (30 minutes)

            $nextAppointment = $startTime + $interval; // Calculate the timestamp for the next appointment
            $nextAppointmentFormatted = date('h:i A', $nextAppointment); // Format the timestamp as a readable time

            $expectedTimeFormatted = $nextAppointmentFormatted; // Assign the value of $nextAppointmentFormatted to $expectedTimeFormatted

            echo "Your next appointment is scheduled for $nextAppointmentFormatted";
                        ...
                        <div  class="dashboard-items search-items"  >
                            ...
                            <div style="width:100%">
                                    ...
                                    <div class="h3-search" style="font-size:18px;">
                                        ...
                                        Channeling fee : <b>ksh.1500.00 </b><br>
                                       Appointment is expected to start at:  <b>@'.substr($expectedTimeFormatted,0,5).'</b>
                    </td>
                <td style="width: 25%;">
                        <div  class="dashboard-items search-items"  >
