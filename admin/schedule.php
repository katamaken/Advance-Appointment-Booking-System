            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-schedule">
                        <a href="reminder.php" class="non-style-link-menu"><div><p class="menu-text">Set Reminder</p></div></a>
                    </td>
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr>
                    <td colspan="4" style="padding-top:0px;width: 100%;" >
                        ...
                        <td width="30%">
                        <select name="docid" id="" name="specialities" id="" class="box filter-container-items" style="width:90% ;height: 37px;margin: 0;" >
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    ...
                                    <option value="" disabled selected hidden>Choose Doctor Name and Speciality from the list</option><br/>';
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="nid" class="form-label">Scheduled Date: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                         ...
                                         for ( $x=0; $x<$result->num_rows;$x++){
                                             ...
                                             echo '<tr style="text-align:center;">
                                                ...
                                                '.substr($pid,0,15).'
                                                 ...
                                                 substr($pname,0,25)
                                                 .'</td >
                                                 <td style="text-align:center;font-size:23px;font-weight:500; color: var(--btnnidetext);">
                                                 '.$apponum.'
